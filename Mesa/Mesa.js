...
// Função para limpar todas as mesas
function clearAllTables() {
  const password = prompt("Digite a senha para limpar todas as mesas:");
  if (password === "admin") {
    // Lógica para limpar todas as mesas
    const tablesContainer = document.getElementById("tablesContainer");
    tablesContainer.innerHTML = ""; // Remove todas as mesas
    alert("Todas as mesas foram limpas com sucesso!");
  } else {
    alert("Senha incorreta. Tente novamente.");
  }
}

// Adicionando evento ao botão "Limpar Todas as Mesas"
document
  .getElementById("clearAllTablesButton")
  .addEventListener("click", clearAllTables);

const reportButton = document.getElementById("reportButton");
reportButton.addEventListener("click", function () {
  window.location.href = "../Relatory/Relatory.html"; // Caminho para o relatório
});
const menuButton = document.getElementById("menuButton");
menuButton.addEventListener("click", function () {
  window.location.href = "../Menu/Menu.html"; // Caminho para o relatório
});
